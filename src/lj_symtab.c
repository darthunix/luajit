...
void dump_symtab_trace(struct lj_wbuf *out, const GCtrace *trace)
{
...
void dump_symtab_proto(struct lj_wbuf *out, const GCproto *pt)
{
  lj_wbuf_addu64(out, (uintptr_t)pt);
...
void lj_new_symbols_dump(uint32_t *lib_adds, struct lj_wbuf *out,
